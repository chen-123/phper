...
<div class="btn-toolbar">
                <div class="btn-group">
                  <a class="btn btn-default " href="<?php echo site_url('application/add') ?>">&nbsp;新增</a>
                  <a class="btn btn-default" href="<?php echo site_url('application/index') ?>">&nbsp;列表</a>
                  <a class="btn btn-default" href="<?php echo site_url('application/trash') ?>">&nbsp;回收站</a>
                </div>
</div> <!-- /toolbar -->               
<hr/>                
...
<input type='hidden'  name='id' value=<?php echo $record['id'] ?> />
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id=""  name="app_email" value="<?php echo $record['app_email']; ?>" >
    </div>
   </div>

...
<div class="btn-toolbar">
                <div class="btn-group">
                  <a class="btn btn-default active" href="<?php echo site_url('application/add') ?>">&nbsp;新增</a>
                  <a class="btn btn-default" href="<?php echo site_url('application/index') ?>">&nbsp;列表</a>
                  <a class="btn btn-default " href="<?php echo site_url('application/trash') ?>"></i>&nbsp;回收站</a>
                </div>
</div> <!-- /toolbar -->               
<hr/>
...
<input type="hidden" name="submit" value="add"/> 
   <div class="control-group">
	...
	<div class="control-group">
    <label class="control-label" for="">*管理员邮箱</label>
    <div class="controls">
      <input type="text" id=""  name="app_email" placeholder=""  value="<?php echo set_value('app_email'); ?>" >
      <span class="help-inline">填写应用管理员邮箱，多个用,隔开</span>
    </div>
   </div>
    <div class="control-group">

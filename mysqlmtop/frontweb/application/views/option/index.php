...
<input type="hidden" name="submit" value="save"/> 
   ...
   <div class="control-group error">
	...
	<div class="control-group error">
    <label class="control-label" for="">*报警周期</label>
    <div class="controls">
      <input type="text" id="alarm_week"  name="alarm_week" value="<?php echo $option['alarm_week'] ?>" >
      <span class="help-inline">此项是设置周一到周日报警天数，用;号分割。0~7,0表示周一，7表示周六。</span>
    </div>
   </div>
	
   <div class="control-group error">
    <label class="control-label" for="">*报警开始时间</label>
    <div class="controls">
      <input type="text" id="alarm_starttime"  name="alarm_starttime" value="<?php echo $option['alarm_starttime'] ?>" >
      <span class="help-inline"></span>
    </div>
   </div>

   <div class="control-group error">
    <label class="control-label" for="">*报警结束时间</label>
    <div class="controls">
      <input type="text" id="alarm_endtime"  name="alarm_endtime" value="<?php echo $option['alarm_endtime'] ?>" >
      <span class="help-inline"></span>
    </div>
   </div>

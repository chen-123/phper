...
<input type='hidden'  name='id' value=<?php echo $record['id'] ?> />
    ...
    <div class="controls">
      <input type="text" id=""  name="alias_host" value="<?php echo $record['alias_host']; ?>" >
   ...
   <div class="control-group">
    ...
    <div class="controls">
      ...
      <span class="help-inline">数据库服务端口</span>
    </div>
   </div>
   <div class="control-group">
    ...
    <div class="controls">
        <select name="idc_type" id="idc_type" >
         <option value="yf"  <?php echo set_selected('yf',$record['idc_type'])?> >西街机房</option>
         <option value="ts" <?php echo set_selected('ts',$record['idc_type'])?> >新村机房</option>
        </select>
   ...
   <div class="control-group">
    ...
    <div class="controls">
        <select name="alarm_time" id="alarm_time" class="input-small">
         <option value="1"  <?php echo set_selected(1,$record['alarm_time']) ?>>开启</option>
         <option value="0"  <?php echo set_selected(0,$record['alarm_time']) ?>>关闭</option>
        </select>
        开始时间&nbsp;<input type="text" id="threshold_starttime" class="input-small" placeholder="开始时间" name="threshold_starttime" value="<?php echo $record['threshold_starttime']; ?>" > 
		结束时间&nbsp;<input type="text" id="threshold_endtime" class="input-small" placeholder="结束时间" name="threshold_endtime" value="<?php echo $record['threshold_endtime']; ?>" >
    </div>
   </div>

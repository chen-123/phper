...
<div class="btn-toolbar">
                <div class="btn-group">
                  ...
                  <a class="btn btn-default active" href="<?php echo site_url('servers/batch_add') ?>">&nbsp;批量新增</a>
...
<table class="table table-hover table-striped  table-bordered table-condensed">
	<tr>
		<th colspan="6"><center>服务器</center></th>
...
<input type="hidden" name="ids[]" value="<?php echo $n ?>" /> 
    <tr style="font-size: 13px;">
		<td><input type="text" name="host_<?php echo $n ?>" class="input-mini" placeholder="内网IP"></td>
		<td><input type="text" name="alias_host_<?php echo $n ?>" class="input-mini" placeholder="外网IP或域名"></td>
        <td><input type="text" name="port_<?php echo $n ?>" class="input-mini" placeholder="端口" value="3306"></td>
        <td><select name="idc_type_<?php echo $n ?>" id="idc_type_<?php echo $n ?>" class="input-small"><option value="">选择机房</option><option value="yf">西街机房</option><option value="ts">新村机房</option></select></td>
        <td><select name="application_id_<?php echo $n ?>" id="application_id_<?php echo $n ?>" class="input-small">

...
<div class="btn-toolbar">
                <div class="btn-group">
                  <a class="btn btn-default <?php if($begin_time=='60') echo 'active'; ?>" href="<?php echo site_url('chart/status/'.$cur_server_id.'/60/hour') ?>">&nbsp;1小时</a>
                  <a class="btn btn-default <?php if($begin_time=='360') echo 'active'; ?>" href="<?php echo site_url('chart/status/'.$cur_server_id.'/360/hour') ?>">&nbsp;6小时</a>
                  <a class="btn btn-default <?php if($begin_time=='720') echo 'active'; ?>" href="<?php echo site_url('chart/status/'.$cur_server_id.'/720/hour') ?>">&nbsp;12小时</a>
                  <a class="btn btn-default <?php if($begin_time=='1440') echo 'active'; ?>" href="<?php echo site_url('chart/status/'.$cur_server_id.'/1440/day') ?>">&nbsp;1天</a>
                  <a class="btn btn-default <?php if($begin_time=='4320') echo 'active'; ?>" href="<?php echo site_url('chart/status/'.$cur_server_id.'/4320/day') ?>">&nbsp;3天</a>
                  <a class="btn btn-default <?php if($begin_time=='10080') echo 'active'; ?>" href="<?php echo site_url('chart/status/'.$cur_server_id.'/10080/day') ?>">&nbsp;1周</a>
                </div>
</div> <!-- /toolbar -->  
